...
import { Car, MapPin, Map, Calendar, Plus, AlertCircle, CheckCircle2, Clock, X, ShieldCheck } from 'lucide-react-native';
...
export default function OfferRide() {
  ...
  return (
    ...
    >
      <ScrollView
        contentContainerStyle={[styles.scrollContent, { backgroundColor: theme.background, flexGrow: 1, paddingBottom: 100 }]}
